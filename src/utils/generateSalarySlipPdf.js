...
export function generateSalarySlipPdf(data) {
  ...
  autoTable(doc, {
    ...
    body: [
      ...
      ["UAN", data.uan, "PF Number", data.pfNumber || data.uan],
      ["ESIC No.", data.esic, "Email", data.email || "-"],
      ["Bank", data.bankName || "-", "Account No.", data.bankAccount],
      ["IFSC", data.ifscCode || "-", "Account Holder", data.accountHolderName || data.name],
    ],
    columnStyles: {
